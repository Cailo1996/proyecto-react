            ...
            <div className='h-screen py-5 m-4 bg-stone-50'>
                ...
                <div className='grid grid-cols-2 m-10'>
                    <div className='text-base not-italic text-black '>
                        ...
                        <br></br>
                        <a href="https://www.rionegro.com.ar/frutos-rojos-con-valor-patagonico-999841/"
                        className='px-4 py-2 font-bold text-white bg-orange-300 rounded hover:bg-orange-500'
